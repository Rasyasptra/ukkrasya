...
class GalleryController extends Controller
{
    ...
    public function photos(Request $request)
    {
        ...
        return view('gallery-photos', compact('photos', 'categories', 'totalPhotos', 'recentPhotos', 'contributors', 'recentInfo', 'userIp', 'userId'));
    }
    ...
    public function downloadPhoto($id)
    {
        ...
        if (!auth()->check()) {
            return redirect()->back()->with('error', 'Anda harus login terlebih dahulu untuk mengunduh foto');
        }
