...
class PhotoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get statistics data (unfiltered counts)
        $totalPhotos = Photo::count();
        $activeCategories = Photo::distinct('category')->count('category');
        ...
        return view('admin.photos.index', compact('photos', 'categories', 'totalPhotos', 'activeCategories', 'activeAdmins', 'photosThisWeek'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            if (request()->wantsJson() || request()->ajax()) {
                return response()->json([
                    'success' => false,
                    'message' => 'Terjadi kesalahan saat menghapus foto. Silakan coba lagi.'
                ], 500);
            }
