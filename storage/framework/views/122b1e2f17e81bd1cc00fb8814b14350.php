...
<div class="container">
    ...
    <div class="stats-section">
        <div class="stat-card">
            <div class="stat-number"><?php echo e($totalInfo); ?></div>
            <div class="stat-label">Total Informasi</div>
        </div>
        <div class="stat-card">
            <div class="stat-number"><?php echo e($publishedInfo); ?></div>
            <div class="stat-label">Diterbitkan</div>
        </div>
        <div class="stat-card">
            <div class="stat-number"><?php echo e($recentInfo); ?></div>
    ...
    <div class="actions-bar">
        ...
        <a href="<?php echo e(route('admin.information.create')); ?>" class="btn-primary">
            ...
            <?php $__currentLoopData = $informations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="info-card">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div class="info-badges">
                                <span class="badge badge-<?php echo e($info->type); ?>">
                                    <?php if($info->type == 'announcement'): ?>
                                        Pengumuman
                                    <?php elseif($info->type == 'news'): ?>
                                        Berita
                                    <?php elseif($info->type == 'event'): ?>
                                        Acara
                                    <?php else: ?>
                                        Umum
                                    <?php endif; ?>
                    ...
                    <div class="info-card-body">
                        <p class="info-content"><?php echo e(Str::limit(strip_tags($info->content), 150)); ?></p>
                        <div class="info-meta">
                            <div class="meta-item">
                                <span><?php echo e($info->creator->name ?? 'Admin'); ?></span>
                            </div>
                            <div class="meta-item">
                                <span><?php echo e($info->created_at->format('d M Y')); ?></span>
                            </div>
                            <?php if($info->published_at): ?>
                                <div class="meta-item">
                                    <span>Terbit: <?php echo e($info->published_at->format('d M Y')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="info-card-footer">
                        <a href="<?php echo e(route('admin.information.edit', $info->id)); ?>" class="btn-sm btn-info">
                            Edit
                        </a>
                        <form method="POST" action="<?php echo e(route('admin.information.destroy', $info->id)); ?>" style="display: inline; margin: 0;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/admin/information/index.blade.php ENDPATH**/ ?>