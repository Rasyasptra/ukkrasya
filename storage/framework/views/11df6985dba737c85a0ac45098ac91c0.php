    ...
    <div class="login-container">
        <div class="header">
            <div class="brand-logo">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="SMK Negeri 4 Bogor" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'font-size: 24px; font-weight: 600; color: #6366f1;\'>SMK N 4</div>';">
            </div>
        ...
        <div class="form-container">
            ...
            <?php if($errors->any()): ?>
                <div class="error-message">
                    <strong>Login gagal!</strong> <?php echo e($errors->first()); ?>

                </div>
            <?php endif; ?>

            <?php if(session('show_admin_login')): ?>
...
<?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/auth/login.blade.php ENDPATH**/ ?>