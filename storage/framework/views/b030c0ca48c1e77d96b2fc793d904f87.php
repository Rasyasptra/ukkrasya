...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo e(route('information.page')); ?>" class="active">Informasi</a></li>
    ...
    <div class="mobile-nav">
        ...
        <ul class="mobile-nav-links">
            ...
            <li><a href="<?php echo e(route('information.page')); ?>" class="active"><i class="fas fa-info-circle"></i> Informasi</a></li>
            <?php if(auth()->guard()->check()): ?>
        ...
        <?php if($informations->count() > 0): ?>
            <div class="info-grid" id="infoGrid">
                <?php $__currentLoopData = $informations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="info-card" data-type="<?php echo e($info->type); ?>">
                        ...
                        <p class="info-content"><?php echo e(Str::limit($info->content, 200)); ?></p>
                        <div class="info-meta">
                            ...
                            <?php if($info->expires_at): ?>
                                <span class="info-expires">
                                    ...
                                    Berlaku hingga <?php echo e($info->expires_at->format('d M Y')); ?>
...
<?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/information-page.blade.php ENDPATH**/ ?>