...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo e(route('gallery.photos')); ?>">Galeri Foto</a></li>
                <li><a href="<?php echo e(route('information.page')); ?>">Informasi</a></li>
                <?php if(auth()->guard()->check()): ?>
                    <li><a href="<?php echo e(route('user.profile')); ?>" class="active">Profil</a></li>
                    <li class="user-menu">
                        <?php if(Auth::user()->avatar): ?>
                            <img src="<?php echo e(asset('avatars/' . Auth::user()->avatar)); ?>" alt="Profile" class="user-avatar" style="width: 36px; height: 36px; border-radius: 50%; object-fit: cover;">
                        <?php else: ?>
    ...
    <div class="mobile-nav">
        ...
        <ul class="mobile-nav-links">
            ...
            <li><a href="<?php echo e(route('gallery.photos')); ?>"><i class="fas fa-images"></i> Galeri Foto</a></li>
            <li><a href="<?php echo e(route('information.page')); ?>"><i class="fas fa-info-circle"></i> Informasi</a></li>
            <?php if(auth()->guard()->check()): ?>
                <li><a href="<?php echo e(route('user.profile')); ?>" class="active"><i class="fas fa-user"></i> Profil</a></li>
            <?php else: ?>
        ...
        <div class="profile-section">
            ...
            <div class="profile-card">
                <div class="profile-avatar">
                    <?php if($user->avatar): ?>
                        <img src="<?php echo e(asset('avatars/' . $user->avatar)); ?>" alt="Profile Photo">
                    <?php else: ?>
                ...
                <div class="profile-stats">
                    <div class="stat-item">
                        <span class="stat-number"><?php echo e($totalLikes); ?></span>
                        <span class="stat-label">Likes</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number"><?php echo e($totalComments); ?></span>
                        <span class="stat-label">Komentar</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number"><?php echo e($likedPhotos); ?></span>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-textarea" rows="3"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 32px;">
                        ...
                        <a href="<?php echo e(route('gallery.photos')); ?>" class="btn btn-outline">
        ...
        <div class="activity-section">
            ...
            <div class="activity-list">
                <?php $__empty_1 = true; $__currentLoopData = $recentLikes->merge($recentComments)->sortByDesc('created_at')->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($activity instanceof \App\Models\Like): ?>
                        <div class="activity-item">
                            ...
                            <div class="activity-content">
                                <div class="activity-text">
                                    Anda menyukai foto <strong><?php echo e($activity->photo->title ?? 'Foto'); ?></strong>
                                </div>
                                <div class="activity-date">
                                    <i class="far fa-clock"></i> <?php echo e($activity->created_at->diffForHumans()); ?>
                    ...
                    <?php else: ?>
                        <div class="activity-item">
                            ...
                            <div class="activity-content">
                                <div class="activity-text">
                                    Anda mengomentari foto <strong><?php echo e($activity->photo->title ?? 'Foto'); ?></strong>
                                </div>
                                <div class="activity-date">
                                    <i class="far fa-clock"></i> <?php echo e($activity->created_at->diffForHumans()); ?>
...
<?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/user/profile.blade.php ENDPATH**/ ?>