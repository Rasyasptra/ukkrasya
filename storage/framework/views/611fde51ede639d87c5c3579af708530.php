...
<div class="main-content">
            <div class="photo-preview-section">
                ...
                <div class="photo-info">
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo e($photo->title); ?></span>
                    </div>
                    
                    <?php if($photo->description): ?>
                        <div class="info-item">
                            <span class="info-label">Deskripsi:</span>
                            <span class="info-value"><?php echo e($photo->description); ?></span>
                        </div>
                    <?php endif; ?>
                    
                    <div class="info-item">
                        <span class="info-label">Kategori:</span>
                        <span class="info-value"><?php echo e(ucfirst($photo->category)); ?></span>
                    </div>
                    
                    <div class="info-item">
                        <span class="info-label">Upload oleh:</span>
                        <span class="info-value"><?php echo e($photo->user->name ?: $photo->user->username); ?></span>
                    </div>
                    
                    <div class="info-item">
                        <span class="info-label">Tanggal upload:</span>
                        <span class="info-value"><?php echo e($photo->created_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    
                    <div class="info-item">
                        <span class="info-label">Terakhir update:</span>
                        <span class="info-value"><?php echo e($photo->updated_at->format('d/m/Y H:i')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="edit-form-section">
                ...
                <form method="POST" action="<?php echo e(route('admin.photos.update', $photo->id)); ?>" enctype="multipart/form-data" onsubmit="saveScrollPosition()">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea id="description" 
                                      name="description" 
                                      rows="4" 
                                      placeholder="Deskripsi foto (opsional)"><?php echo e(old('description', $photo->description)); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <?php $__currentLoopData = \App\Helpers\CategoryHelper::getCategories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('category', $photo->category) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($name); ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('admin.photos.index')); ?>" class="cancel-btn">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/admin/photos/edit.blade.php ENDPATH**/ ?>