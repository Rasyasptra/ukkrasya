...
<body>
    <div class="login-wrapper">
        ...
        <div class="login-right">
            ...
            <form method="POST" action="<?php echo e(route('user.login.post')); ?>" id="loginForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input 
                            ...
                            type="text" 
                            name="username" 
                            value="<?php echo e(old('username', 'user')); ?>" 
            ...
            <div class="back-link" style="margin-bottom: 16px;">
                <a href="<?php echo e(route('register')); ?>" style="color: #60a5fa;">
                    <svg viewBox="0 0 24 24">
...
</html><?php /**PATH C:\xampp\htdocs\ujikomrasya\resources\views/auth/user-login.blade.php ENDPATH**/ ?>