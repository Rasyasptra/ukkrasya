...
<style>
        ...
        <div class="stats-overview">
            ...
            <div class="stat-card">
                <div class="stat-number">{{ $activeCategories ?? $photos->groupBy('category')->count() }}</div>
        ...
        <div class="search-filter-section">
            <div class="search-container">
                <form method="GET" action="{{ route('admin.photos.index') }}" class="search-form" onsubmit="saveScrollPosition()">
            ...
            @if(request('search') || (request('category') && request('category') !== 'all'))
                <div class="search-results-info">
                    <div class="results-count">
                        Ditemukan <strong>{{ $photos->count() }}</strong> foto
                        @if(request('search'))
        ...
        <div class="modal-overlay" id="uploadModal" onclick="closeModalOnOverlay(event)">
            <div class="modal-container" onclick="event.stopPropagation()">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('admin.photos.store') }}" enctype="multipart/form-data" id="uploadForm" onsubmit="saveScrollPosition()">
                    @csrf
        ...
        <div class="photos-section">
            <div class="section-header">
                ...
                <div class="photo-count">
                    <span class="count-badge">{{ $totalPhotos ?? $photos->total() }}</span>
