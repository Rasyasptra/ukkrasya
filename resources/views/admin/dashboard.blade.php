...
<div class="card" style="margin-bottom: 32px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
        ...
        <a href="{{ route('gallery.index') }}" class="btn btn-primary" target="_blank" style="text-decoration: none; justify-content: center;">
            Lihat Galeri
        </a>
    </div>
</div>
            ...
            @foreach($recentPhotos as $photo)
                <div style="text-align: center;">
                    <div style="width: 100%; height: 120px; border-radius: 8px; overflow: hidden; margin-bottom: 8px; border: 1px solid #e2e8f0;">
                        <img src="{{ $photo->photo_url }}" alt="{{ $photo->title }}" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
